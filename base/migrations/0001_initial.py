# Generated by Django 3.2.7 on 2024-07-31 23:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('UP', 'Up Coming'), ('DR', 'During Training'), ('FN', 'Finished')], max_length=2)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.course')),
                ('roomm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.chatroom')),
            ],
            options={
                'ordering': ['start'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_method', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='receive_method', to='base.paymentmethod')),
                ('send_method', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='send_method', to='base.paymentmethod')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='base.chatroom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_history', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='base.paymenthistory')),
                ('training_session', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='base.trainingsession')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
